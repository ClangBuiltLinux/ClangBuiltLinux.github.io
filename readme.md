...
- IRC: `#clangbuiltlinux` on chat.freenode.net
  - Connect via [webchat](http://webchat.freenode.net/?channels=clangbuiltlinux)
  - Also bridged with [#clangbuiltlinux:matrix.org](https://matrix.to/#/!DSGCNZRLDkmzZGXJkF:matrix.org)
